// TODO: Add running rage counter to top
// TODO: Make lightning increase/decrease in size with SamJack's rage
...
// TODO: Consider final shade of purple (lighter?)
// TODO: Consider final appearance of countdown (light gray, larger, end on 'Type mofo'?)
// TODO: Add firebase leaderboard
// TODO: It seems that it takes about an extra second for first inactivity ragePoint to build -- fix that?
// TODO: Fix flames against left and right boundaries of screen
...
$(document).ready(function(){
  ...
  function samJackAngerGrows(sound) {
    samJackRagePoints += 1  
    $("#rage_points_display").text("Mr. Jackson's Rage Points: " + samJackRagePoints + " (If he hits 20, you lose!)")
    if (sound) {
  ...
  function displayText() {
    ...
    $("#rage_points_display").text("Mr. Jackson's Rage Points: " + samJackRagePoints + " (If he hits 20, you lose!)")
    $("#rage_points_display").animate({opacity:1}, 2000)
  }
